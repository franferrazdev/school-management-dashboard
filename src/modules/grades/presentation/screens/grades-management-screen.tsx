...
// Instancia o cliente fora do componente para evitar re-renderização coloquial
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-s-stone-800 pb-4">
          <div>
            ...
            <p className="text-sm text-stone-400">
              Escola de Elite - Gestão estrita de notas, simulados estruturados
              e metas vestibulares.
            </p>
          </div>
